...
const SClient = require('../../classes/clientData/SClient.js');
const { ActivityType } = require('discord.js');
const client = SClient.getClient();


module.exports = {
    data: new SlashCommandBuilder()
        .setName('hello')
        .setDescription('Da oi'),
    /*
    ...
    */
    async execute(interaction) {
        ...
        client.user.setActivity('OLÁ ' + interaction.user.username, { type: ActivityType.Custom});
